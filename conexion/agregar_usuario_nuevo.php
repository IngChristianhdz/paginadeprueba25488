...
if(isset($_POST["sexo"])){
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $query="INSERT into alta (correo, password, sexo, nombre, domicilio, ciudad, estado, telefono, pregunta, respuesta, terminos, celular) VALUES ('$correo','$contra','$sexo', '$nombre', '$domicilio', '$ciudad', '$estado', '$telefono', '$pregunta', '$respuesta','$terminos', '$celular')";
        $result = mysqli_query($connection, $query);
        }    
