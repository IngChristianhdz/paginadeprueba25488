...
<html lang="es">
   ...
   <main>
        ...
        <!--banner-->        
        <section style=" width: 100%;height: 100%;display: flex;align-items: center;justify-content: center;" id="banner">
               <div class="contenedor" >
                <h1 style="text-align: center;" >"Archivos de Terminales"</H1>
...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="margin: 0 auto;">
      ...
      <thead>
      <tr>
      <td><h2>Terminales</H2></td>      
      <td><h2>Nombre del Archivo</H2></td>
      <td><h2>Descarga el Archivo</H2></td>            
      </tr>
      </thead>
      <tbody>
      <?php
      ...
      <tr>
        <td><?php echo $mostrar['portatil']?> </td>        
        <td><?php echo $mostrar['nombrefile']?></td>
        <td><a href="ws/<?php echo $mostrar['portatil'];?>/<?php echo $mostrar['nombrefile'];?>" class="btn btn-primary" download>Download</a></td>
